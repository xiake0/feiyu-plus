...
public interface MenuMapper extends BaseMapper<Menu> {
    ...
    @Select("select t.id,t.name,t.level,t.title,t.path,t.del_flag,t.in_active,t.component," +
    ...
    @Select("SELECT m.id,m.name,m.level,m.title,m.path,m.del_flag,m.in_active,m.icon,m.sort_order,m.parent_id,m.url,m.component," +
